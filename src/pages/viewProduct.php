        ...
        <form class="w-full" method="POST" action="../actions/postComment.php">
            ...
            <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                <div class="px-4 py-2 bg-white rounded-t-lg dark:bg-gray-800">
                    ...
                    <label for="review_rating" class="block mb-2 mt-4 text-sm font-medium text-gray-900 dark:text-white">Select your Rating</label>
                    ...
                    <label class="block mb-2 mt-4 text-sm font-medium text-gray-900 dark:text-white" for="review_desc">Your Comment</label>
