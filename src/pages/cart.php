...
<div class="mt-10 children:my-3">
    ...
    <div class="grid grid-cols-1 grid-rows-1 md:grid-cols-3" id="cart">
        <div class="w-full col-span-2 px-4 py-4 bg-white lg:px-8 lg:py-14 md:px-6 md:py-8 dark:bg-gray-800" id="scroll">
            <p class="pt-3 mb-4 text-3xl font-black leading-10 text-gray-800 lg:text-4xl dark:text-white">Your Cart</p>
