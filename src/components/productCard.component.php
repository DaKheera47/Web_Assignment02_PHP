...
<div data-selector="' . $type . '" id=' . $id . ' class="productCard w-full max-w-sm bg-white dark:bg-gray-800 border dark:border-none border-gray-200 rounded-lg shadow">
    ...
    <div class="px-5 pb-5">
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="#" class="text-white bg-uclan-blue hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-uclan-blue font-medium rounded-lg text-sm px-5 py-2.5 text-center">Add to cart</a>
        </div>
    </div>
</div>
    ';
