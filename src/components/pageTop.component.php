...
<body class="dark:bg-gray-800 dark:text-white pt-16 md:pt-24">
    <nav class="fixed top-0 left-0 w-full bg-uclan-red text-white border-gray-200 py-2.5 rounded px-[5vw]">
        <div class="container flex flex-wrap md:flex-nowrap items-center justify-between mx-auto max-w-screen-xl">
            ...
            <div class="flex">
                <button onclick="toggleDarkMode()" type="button" class="block md:hidden text-white focus:outline-none hover:text-uclan-red hover:bg-gray-100 rounded-lg text-sm p-2.5">
            ...
            <ul id="nav-content" class="hidden w-full md:w-3/5 lg:w-2/5 md:flex flex-col p-4 my-4 text-white rounded-lg justify-center items-center md:flex-row md:space-x-8 md:my-0 md:text-sm md:font-medium md:border-0 divide-y-2 md:divide-y-0">
                ...
                <li class="w-full text-center">
                    <button onclick="toggleDarkMode()" type="button" class="hidden md:block text-white focus:outline-none hover:text-uclan-red hover:bg-gray-100 rounded-lg text-sm p-2.5">
                        <svg fill="currentColor" class="w-6 h-6" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414 1.414zm2.12-10.607a1 1 0 010 1.414l-.706.707a1 1 0 11-1.414-1.414l.707-.707a1 1 0 011.414 0zM17 11a1 1 0 100-2h-1a1 1 0 100 2h1zm-7 4a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zM5.05 6.464A1 1 0 106.465 5.05l-.708-.707a1 1 0 00-1.414 1.414l.707.707zm1.414 8.486l-.707.707a1 1 0 01-1.414-1.414l.707-.707a1 1 0 011.414 1.414zM4 11a1 1 0 100-2H3a1 1 0 000 2h1z" fill-rule="evenodd" clip-rule="evenodd"></path>
                        </svg>
                    </button>
